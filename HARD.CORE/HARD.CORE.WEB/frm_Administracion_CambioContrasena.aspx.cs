...
using System;
using System.Web;
public partial class frm_Administracion_CambioContrasena : System.Web.UI.Page
{
    ...
    protected void btnCambiar_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            else
            {
                ...
                UsuarioSER.GetInstance().ActualizaContrasena(usuario.ClaveUsuario, passwordUsuario);
                bool result = UsuarioSER.GetInstance().EnviarAvisoCambioContrasena(usuario.ClaveUsuario);
